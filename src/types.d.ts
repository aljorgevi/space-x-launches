// To parse this data:
//
//   import { Convert, SpaceXAPI } from "./file";
//
//   const spaceXAPI = Convert.toSpaceXAPI(json);
//
...
export class Convert {
	public static toSpaceXAPI(json: string): SpaceXAPI {
		return cast(JSON.parse(json), r('SpaceXAPI'))
	}

	public static spaceXAPIToJson(value: SpaceXAPI): string {
		return JSON.stringify(uncast(value, r('SpaceXAPI')), null, 2)
	}
}
...
const typeMap: any = {
	...
	DatePrecision: ['hour'],
	Launchpad: ['5e9e4501f509094ba4566f84', '5e9e4502f509092b78566f87', '5e9e4502f5090995de566f86'],
	Rocket: ['5e9d0d95eda69955f709d1eb', '5e9d0d95eda69973a809d1ec']
}
